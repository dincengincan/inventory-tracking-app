    ...
    <div className="App">
      ...
      <form onSubmit={handleSubmit}>
        <div className="input-area">
          ...
          <input className="input" onChange={handleUsernameChange}  value={username} name="username-field" type="text"/>
        </div>
        <div className="input-area">
          <label htmlFor="password-field">Password</label>
          <input className="input" onChange={handlePasswordChange} value={password} name="password-field" type="password"/>
        </div>
        <div className="input-area">
          <label>User Type</label>
            <select className="input" value={dropdownValue} onChange={handleDropdownChange}>
